<script>
	import notes from './data/index.json';

	const { classification, essentials, terminology } = notes;

	const typography = terminology.filter((word) => word.term === 'typography');
...
<main>
	...
	<h2>Terminology</h2>
	<h3>The Anatomy of a Typeface</h3>
	<dl>
